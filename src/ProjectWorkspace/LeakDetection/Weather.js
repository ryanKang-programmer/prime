...
export const Weather = (props) => {
    ...
    loadModules(
      ...
      const weatherDataLayer = new FeatureLayer({
        url: "https://services.arcgis.com/zmLUiqh7X11gGV2d/arcgis/rest/services/EnvironmentCanada/FeatureServer"
      });

      map.add(weatherDataLayer);
      const popupTemplate= {
